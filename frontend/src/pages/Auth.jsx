      ...
      >
        ...
        <div className="text-center">
          ...
          <p className="mt-2 text-sm font-medium text-ink/60">
            Please select your role and sign in with Google to continue.
          </p>
        </div>
        ...
        <button
          ...
          className="mt-8 w-full flex justify-center items-center gap-3.5 py-4 px-4 border border-line/65 rounded-xl shadow-md text-sm font-bold uppercase tracking-wider text-surface bg-ink hover:bg-jade transition-colors focus:outline-none"
        >
